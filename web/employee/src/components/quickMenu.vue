<template>
    <div class="quick-menu" ref="quickMenu" :style="quickMenuStyle">
        <div v-for="(n,key) in menuCount" class="sub-menu" :style="getSubMenu(n-1)" :key="key">
            ...
            <a  :style="subMenuStyle" @mouseover.stop="mouseEnterSubMenu"
               @mouseout.stop="mouseOutSubMenu"
               @click="locateTo(menuUrlList[n-1].url)" :title="menuUrlList[n-1].title">
...
<script>
    export default {
        ...
        data() {
            return {
                menuSize: 60,
                subMenu5:[[["0", "-160"], ["-61.23", "-147.8"], ["-113", "-113"], ["-147.8", "61.23"],["-160","0"]],
                    [["0", "-160"], ["61.23", "-147.8"], ["113", "-113"], ["-147.8", "61.23"],["160","0"]],
                    [["0", "160"], ["147.8", "61.23"], ["113", "113"], ["61.23", "-147.8"],["160","0"]],
                    [["-160", "0"], ["-147.8", "61.23"], ["-113", "113"], ["-61.23", "147.8"],["0","160"]]],
                subMenu4: [[["0", "-160"], ["-80", "-138.6"], ["-138.6", "-80"], ["-160", "0"]],
                ...
                subMenu2: [[["-160", "0"], ["0", "-160"]],
                    [["0", "-160"], ["160", "0"]], [["0", "160"], ["160", "0"]], [["-160", "0"], ["0", "160"]]]
            }
        },
        methods: {
            getSubMenu(n) {
